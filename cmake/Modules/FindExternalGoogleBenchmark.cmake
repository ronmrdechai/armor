...
if(NOT ExternalGoogleBenchmark_FIND_VERSION)
    set(BENCHMARK_TAG master)
else()
    set(BENCHMARK_TAG "v${ExternalGoogleBenchmark_FIND_VERSION}")
endif()
...
set(BENCHMARK_VERSION_STRING ${ExternalGoogleBenchmark_FIND_VERSION})

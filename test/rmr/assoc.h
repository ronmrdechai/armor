...
template <typename T> T less_trie() = delete;
template <> trie_map less_trie<trie_map>() { return trie_map { {"aaa", 1}, {"bbb", 1}, {"ccc", 1} }; }
template <> trie_set less_trie<trie_set>() { return trie_set { "aaa", "bbb", "ccc" }; }

template <typename T> T greater_trie() = delete;
template <> trie_map greater_trie<trie_map>() { return trie_map { {"bbb", 1}, {"ccc", 1}, {"ddd", 1} }; }
template <> trie_set greater_trie<trie_set>() { return trie_set { "bbb", "ccc", "ddd" }; }
